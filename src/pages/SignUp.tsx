...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Congo (Republic)', iso: 'CG', dialCode: '+242', flag: '🇨🇬' },
  ...
  { name: 'Korea (North)', iso: 'KP', dialCode: '+850', flag: '🇰🇵' },
  { name: 'Korea (South)', iso: 'KR', dialCode: '+82', flag: '🇰🇷' },
...
function SignUp({ onSwitchToSignIn }: SignUpProps) {
  ...
  // Auto-detect country by IP with multiple fallbacks
  useEffect(() => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/verify-email', { state: { email, fromRegister: true } })
    } catch (err: any) {
      ...
      <div className="login-right-panel">
        <div className="login-form-container">
          ...
          <div className="login-header">
            <h2 className="login-title">Sign up account</h2>
              ...
              <div className="phone-input-wrapper">
                ...
                <div className="country-code-dropdown" ref={dropdownRef}>
                  <button
                    ...
                    onClick={() => { setDropdownOpen(prev => !prev); setCountrySearch('') }}
                  >
